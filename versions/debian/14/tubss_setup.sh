...
# - [Debian] Added Debian 14 support: deb.debian.org, apparmor-utils, ifupdown network config, no ubuntu-report, fastfetch.
#
# Provided by Joka.ca
#==============================================================================
...
run_preflight() {
    ...
    # Warn if running Debian 14 (Forky — testing tier)
...
install_packages() {
    ...
    local PACKAGES=("curl" "ufw" "unattended-upgrades" "apparmor" "apparmor-utils" "net-tools" "htop" "fastfetch" "vim" "build-essential" "rsync")
